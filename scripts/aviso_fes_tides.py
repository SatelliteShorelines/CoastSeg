...
load_tide_files = {'2n2.nc.gz': 65738083, 'eps2.nc.gz': 59648992, 'j1.nc.gz': 63674897, 'k1.nc.gz': 92483370, 'k2.nc.gz': 79058819, 'l2.nc.gz': 66194514, 'la2.nc.gz': 60549789, 'm2.nc.gz': 100588509, 
'm3.nc.gz': 58990134, 'm4.nc.gz': 62106516, 'm6.nc.gz': 61730021, 'm8.nc.gz': 57998586, 'mf.nc.gz': 61632949, 'mks2.nc.gz': 59124980, 'mm.nc.gz': 58505186, 'mn4.nc.gz': 61385688, 'ms4.nc.gz': 61621572, 'msf.nc.gz': 57210912, 'msqm.nc.gz': 54526221, 'mtm.nc.gz': 55814427, 'mu2.nc.gz': 67397939, 'n2.nc.gz': 84849067, 'n4.nc.gz': 58485930, 'nu2.nc.gz': 68199478, 'o1.nc.gz': 89167839, 'p1.nc.gz': 78789560, 'q1.nc.gz': 70454645, 'r2.nc.gz': 59159817, 's1.nc.gz': 61028520, 's2.nc.gz': 92191832, 's4.nc.gz': 60449978, 'sa.nc.gz': 55141801, 'ssa.nc.gz': 54751841, 't2.nc.gz': 65009788}

ocean_tide_files = {'2n2.nc.gz': 79421243, 'eps2.nc.gz': 79466239, 'j1.nc.gz': 79181150, 'k1.nc.gz': 79165326, 'k2.nc.gz': 79135202, 'l2.nc.gz': 79173251, 'la2.nc.gz': 79224898, 'm2.nc.gz': 79281037, 'm3.nc.gz': 80194478, 'm4.nc.gz': 80192222, 'm6.nc.gz': 80193774, 'm8.nc.gz': 80194731, 'mf.nc.gz': 72780320, 'mks2.nc.gz': 80164550, 'mm.nc.gz': 69732455, 'mn4.nc.gz': 79925609, 'ms4.nc.gz': 80055330, 'msf.nc.gz': 77420794, 'msqm.nc.gz': 75451767, 'mtm.nc.gz': 73869165, 'mu2.nc.gz': 79540681, 'n2.nc.gz': 79375675, 'n4.nc.gz': 80149977, 'nu2.nc.gz': 79410976, 'o1.nc.gz': 79253088, 'p1.nc.gz': 79109813, 'q1.nc.gz': 79168065, 'r2.nc.gz': 79300001, 's1.nc.gz': 79115934, 's2.nc.gz': 79245970, 's4.nc.gz': 80037548, 'sa.nc.gz': 78641422, 'ssa.nc.gz': 66958840, 't2.nc.gz': 79210226}
    ...
    if tarmode:
        ...
        with tqdm(total=total_size, unit='B', unit_scale=True, ncols=100) as pbar:
            for m in member_files:
                ...
                # print(fileBasename)
                if fileBasename in missing_files:
