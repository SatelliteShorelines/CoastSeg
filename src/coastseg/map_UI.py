...
class TidesSelector(widgets.VBox):
    ...
    def create_file_chooser_with_clear(self, callback, title="Select a file", filter_pattern="*.csv"):
        ...
        instructions = widgets.HTML(value="""Upload a CSV file containing the tides.The CSV file must follow the file format listed here: 
                                     <a href="https://ipywidgets.readthedocs.io/en/stable/examples/Widget%20List.html#boolean-widgets" target="_blank">File Format</a>""",
...
class UI:
    ...
    def create_tidal_correction_widget(self, id_container: "traitlets.HasTraits"):
        ...
        self.beach_slope_selector = BeachSlopeSelector()
        self.tide_selector = TidesSelector()
