...
class Reference_Shoreline_Buffer(Feature):
    LAYER_NAME = "reference_shoreline_buffer"
    ...
    def __init__(
        ...
        """Initialize the Reference_Shoreline_Buffer object"""
        if gdf is not None:
            self.gdf = gdf
        else:
            self.gdf = gpd.GeoDataFrame()
        self.filename = filename if filename else "reference_shoreline_buffer.geojson"
