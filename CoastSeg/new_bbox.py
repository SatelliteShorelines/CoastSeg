...
# BROKEN @TODO test to make sure it works with python files located in sub directorys
# MAKE IT WORK WITH PATHLIB
# MAKE IT WORK WITH STRINGS
# HAVE A BACKUP WHERE IT MANUALLY CHECKS THE LOCATION
# LASTLY HAVE IT RAISE THE FILENOTEFOUND EXCEPTION
